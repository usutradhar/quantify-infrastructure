...
- Roadway network length (RL) is extracted from OpenStreetMap and coverted to dataframes summarized by roadway type for cities using [read_OSM_2_df_m.ipynb](https://github.com/usutradhar/quantify-infrastructure/blob/main/0_read_OSM_2_df_m.ipynb) & [read_OSM_2_df_CFT.ipynb](https://github.com/usutradhar/quantify-infrastructure/blob/main/0_read_OSM_2_df_CFT.ipynb)
