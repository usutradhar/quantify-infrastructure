...
def project_infrastructure_ssp4(input_df,
        ...
        if infrastructure == 'RBUV':
            ...
            df_urban_rural_conn = pd.read_csv(output_path + 'output_city_type_ssp4.csv')
        ...
        if infrastructure == 'RBUV':
            ...
            # save output files
            projected_perCap[['GEOID', 'NAMELSAD', 'city type','REGION', 'ALAND', 'CensusPop_20','ssp42030', 'ssp42040','ssp42050', 'ssp42060','ssp42070', 'ssp42080', 'ssp42090', 'ssp42100', 
                            ...
                            'volume_m3_perCap_2080', 'volume_m3_perCap_2090', 'volume_m3_perCap_2100']].to_csv(output_path + 'buildings_perCap_ssp4.csv')
            ...
            projected_perCap[['STATEFP','GEOID', 'NAMELSAD', 'city type', 'citytype_at_2030', 'citytype_at_2040', 'citytype_at_2050','citytype_at_2060', 'citytype_at_2070', 'citytype_at_2080',
                                'citytype_at_2090', 'citytype_at_2100']].to_csv(output_path + 'output_city_type_ssp4.csv')
            ...
            projected_perCap[['GEOID', 'NAMELSAD','length_m_perCap_2020','length_m_perCap_2030', 'length_m_perCap_2040', 'length_m_perCap_2050', 'length_m_perCap_2060', 
                        ...
                        ]].to_csv(output_path + 'roads_perCap_ssp4_local.csv')
