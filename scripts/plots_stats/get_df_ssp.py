...
def get_df_ssp(filepath = r'outputfiles\csvs\\'): # r'outputfiles\csvs_42\\'):
    ...
    df_buildings_ssp2 = pd.read_csv(filepath + 'RE_buildings_perCap_ssp2.csv', index_col = 0)
    df_buildings_ssp2['GEOID'] = df_buildings_ssp2['GEOID'].astype('str').str.rjust(7, '0')

    df_roads_ssp2 = pd.read_csv(filepath + 'RE_roads_perCap_ssp2_local.csv', index_col = 0)
    ...
    # rename columns
    length_cols = ['length_m_perCap_2020', 'length_m_perCap_2030','length_m_perCap_2040', 'length_m_perCap_2050', 'length_m_perCap_2060',
               'length_m_perCap_2070', 'length_m_perCap_2080', 'length_m_perCap_2090', 'length_m_perCap_2100']

    built_cols =['volume_m3_perCap_2020', 'volume_m3_perCap_2030', 'volume_m3_perCap_2040','volume_m3_perCap_2050', 'volume_m3_perCap_2060',
    ...
    df_buildings = df_buildings_ssp2[['GEOID','volume_m3_perCap_2020', 'volume_m3_perCap_2030', 'volume_m3_perCap_2040','volume_m3_perCap_2050', 'volume_m3_perCap_2060',
                'volume_m3_perCap_2070', 'volume_m3_perCap_2080', 'volume_m3_perCap_2090', 'volume_m3_perCap_2100']]
    df_buildings = df_buildings.rename(columns={c: f"{c}_ssp2" for c in built_cols})
    df_roads_ssp2 = df_roads_ssp2.rename(columns={c: f"{c}_ssp2" for c in length_cols})
    df_roads = df_roads_ssp2.copy()

    # merge buildings and roads
    df_ssp = df_buildings.merge(df_roads[['GEOID', 'label', 'future trend from SSP 2', 'weighted_HU_density_sqmi', 'median_income',
          'length_m_perCap_2020_ssp2','length_m_perCap_2030_ssp2', 'length_m_perCap_2040_ssp2', 'length_m_perCap_2050_ssp2', 'length_m_perCap_2060_ssp2',
          'length_m_perCap_2070_ssp2', 'length_m_perCap_2080_ssp2', 'length_m_perCap_2090_ssp2', 'length_m_perCap_2100_ssp2']], on =['GEOID'])
    ...
    df_pop = df_population.merge(df_attr[['GEOID', 'REGION', 'city type', 'tt_2_work_place', 'no_veh', 'veh_1', 'veh_2_or+', 'veh 1+','veh_<=_1']], on ='GEOID')

    df_ssp = df_ssp.merge(df_pop[['GEOID','CensusPop_20', 'ssp22030', 'ssp22040', 'ssp22050', 'ssp22060', 'ssp22070', 'ssp22080', 'ssp22090', 'ssp22100',
                                  'ssp42030', 'ssp42040', 'ssp42050', 'ssp42060', 'ssp42070', 'ssp42080', 'ssp42090', 'ssp42100', 'NAMELSAD', 'REGION', 'city type',
