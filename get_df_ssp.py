...
def get_df_ssp(filepath =r'D:\Work\Box Sync\Quantify Infrastructure\output_csvs\\'):
    ...
    df_roads_ssp2 = pd.read_csv(r'D:\Work\Box Sync\Quantify Infrastructure\output_csvs\roads_perCap_ssp2_x_local.csv', index_col = 0)
    df_roads_ssp2['GEOID'] = df_roads_ssp2['GEOID'].astype('str').str.rjust(7, '0')

    df_buildings_ssp2 = pd.read_csv(r'D:\Work\Box Sync\Quantify Infrastructure\output_csvs\buildings_perCap_ssp2.csv', index_col = 0)
    ...
    df_population = pd.read_csv(r'D:\Work\Box Sync\PhD_Work_Uttara\NC_submission_shared\Final_submission\Analysis Output\forecasted_trend.csv', index_col =0)
    df_population['GEOID'] = df_population['GEOID'].astype(str).str.rjust(7, '0')

    df_attr = pd.read_csv(r'D:\Work\Box Sync\PhD_Work_Uttara\NC_submission_shared\Final_submission\Analysis Output\df_attributes.csv', index_col =0)
