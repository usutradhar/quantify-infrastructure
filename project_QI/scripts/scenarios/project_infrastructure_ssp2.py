...
def project_infrastructure_ssp2(input_df,
        ...
        if infrastructure == 'RBUV':
            ...
            df_urban_rural_conn = pd.read_csv(output_path + 'output_city_type_ssp2.csv')
        ...
        df_for_2030 = process_stock_at_t(df_for_analysis, current_stock_col, current_pop_col, next_pop_col, t, case = case, infrastructure = infrastructure)
        ...
        for i in range(steps):        
            ...
            df_for_t = process_stock_at_t(df_for_analysis, current_stock_col, current_pop, next_pop, t, case = case, infrastructure = infrastructure)
            end_time = time.time()
        ...
        if infrastructure == 'RBUV':
            ...
            # save output files
            projected_perCap[['GEOID', 'NAMELSAD', 'city type','REGION', 'ALAND', 'CensusPop_20','ssp22030', 'ssp22040','ssp22050', 'ssp22060','ssp22070', 'ssp22080', 'ssp22090', 'ssp22100', 
                            ...
                            'volume_m3_perCap_2080', 'volume_m3_perCap_2090', 'volume_m3_perCap_2100']].to_csv(output_path + 'buildings_perCap_ssp2.csv')
            ...
            projected_perCap[['STATEFP','GEOID', 'NAMELSAD', 'city type', 'citytype_at_2030', 'citytype_at_2040', 'citytype_at_2050','citytype_at_2060', 'citytype_at_2070', 'citytype_at_2080',
                                'citytype_at_2090', 'citytype_at_2100']].to_csv(output_path + 'output_city_type_ssp2.csv')
            ...
            projected_perCap[['GEOID', 'NAMELSAD','length_m_perCap_2020','length_m_perCap_2030', 'length_m_perCap_2040', 'length_m_perCap_2050', 'length_m_perCap_2060', 
                        ...
                        ]].to_csv(output_path + 'roads_perCap_ssp2_local.csv')
