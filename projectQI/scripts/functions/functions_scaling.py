...
def find_next_stock(df, current_stock_col, current_pop_col, next_pop_col, citytype, t):
    ...
    # else:
    #     # Fit the log-log linear model for 2020data 
    #     x = find_scale_parameters(df_for_fitting, infra_col='cl_total_length', pop_col = 'CensusPop_20')
...
def process_stock_at_t(df_for_analysis, current_stock_col, current_pop_col, next_pop_col, t):
    ...
    df_2040_urban = find_next_stock(df_for_analysis, current_stock_col, current_pop_col, next_pop_col, list_of_city_types[0],t)
    df_2040_suburban = find_next_stock(df_for_analysis, current_stock_col, current_pop_col, next_pop_col, list_of_city_types[1],t)
    df_2040_periurban = find_next_stock(df_for_analysis, current_stock_col, current_pop_col, next_pop_col, list_of_city_types[2],t)
    df_2040_rural = find_next_stock(df_for_analysis, current_stock_col, current_pop_col, next_pop_col, list_of_city_types[3],t)
